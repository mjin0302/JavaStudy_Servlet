                    ...
                    <c:forEach var="vo2" items="${ vo2 }"> 
	                    <div class="col mb-5">
	                        <div class="card h-100">
	                            ...
	                            <!-- Product image-->
	                            <img class="card-img-top" src="images/${ vo2.image }" alt="${ vo2.image }" />
	                            <!-- Product details-->
	                            <div class="card-body p-4">
	                                <div class="text-center">
	                                    <!-- Product name-->
	                                    <h5 class="fw-bolder">${ vo2.productName }</h5>
	                                    <!-- Product reviews-->
	                                    ...
	                                    <!-- Product price-->
	                                    <span class="text-muted text-decoration-line-through">${ vo2.productPrice }원</span>
	                                    ${ vo2.salePrice }원
	                                </div>
	                            </div>
	                            <!-- Product actions-->
